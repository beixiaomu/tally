...
<script>
    ...
    $(function () {
        ...
        function initTable() {
            $('#table').bootstrapTable({
                url: '${pageContext.request.contextPath}/info/student/expense/loadListData',
                dataType: "json",
                method: 'get',                      //请求方式（*）
    ...
    function edit(id) {
        isUpdate = true;
        $.ajax({
            url: "${pageContext.request.contextPath}/info/student/expense/select/" + id,
            type: "GET",
            dataType: "json",
            success: function (r) {
                if (r.status == 200) {
    ...
    function del(id) {
        $.ajax({
            url: "${pageContext.request.contextPath}/info/student/expense/delete/" + id,
            type: "GET",
            dataType: "json",
            success: function (data) {
                if (data.status == 200) {
