		...
		<div class="row">
			<div id="toolbar" class="btn-group">
				<button id="btn_add" type="button" class="btn btn-default"
					onclick="add()" data-toggle="modal" data-target="#studentModal"
					data-whatever="增加">
				...
				<button id="import" class="btn btn-default" class="btn btn-default"
					data-toggle="modal" data-target="#importModal" data-whatever="导入">
					<span class="glyphicon glyphicon-export" aria-hidden="true"></span>导入
				</button>
				<a id="export" class="btn btn-default"
					href="${pageContext.request.contextPath}/student/export"> <span
					...
					<div class="modal-body">
						<form>
							...
							<div class="form-group">
								<label class="control-label" for="name">名字：</label> <input
									type="text" class="form-control" id="name">
							</div>
							<div class="form-group">
								<label for="age-text" class="control-label">年龄:</label> <input
									class="form-control" id="age-text"></input>
							</div>
							<div class="form-group">
								<label for="major-text" class="control-label">学科:</label> <input
									class="form-control" id="major-text"></input>
							</div>
						</form>
					</div>
		...
		<div class="modal fade" id="importModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="/student/import" method="post" id="importForm"
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var e = '<button class="btn bg-primary" onclick="edit('
														+ row.sno
														+ ')" data-toggle="modal" data-target="#studentModal" data-whatever="编辑">编辑</button> ';
