...
//import com.zhwl.school.common.Constant;
//
///**
// * 签名算法
// * 
...
//		List<Map<String, Object>> list = (List<Map<String, Object>>) JsonMapper
//				.getInstance().fromJsonString(jsonString, List.class);
//		// 遍历排序后的字典，将所有参数按"key=value"格式拼接在一起
//		StringBuilder basestring = new StringBuilder("");
